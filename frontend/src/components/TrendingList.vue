<template>
  <div class="trending-list">
    <div v-for="movie in trendingMovies" :key="movie.id" class="suggestion-item" @click="$emit('selectMovie', movie)" style="cursor:pointer; background: white; border-radius: 12px; padding: 16px; margin-bottom: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.08); transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1);">
...
const props = defineProps<{ trendingMovies: Array<any> }>()
